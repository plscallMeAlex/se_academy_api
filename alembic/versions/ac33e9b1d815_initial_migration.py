...
Revision ID: ac33e9b1d815
Revises: 
Create Date: 2024-10-03 18:58:23.005865
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('freshman', 'sophomore', 'junior', 'senior', 'graduate', 'admin', name='roleenum'), nullable=True),
